...
namespace GliderBoy.Controllers
{
    ...
    public class Sound
    {
        ...
        [Range(0.0f, 1.0f)] public float audioVolume = 1;
        [Range(0.0f, 3.0f)] public float audioPitch = 1;
        ...
        public void Play()
        {
            ...
            sourceToPlay.volume = audioVolume;
            sourceToPlay.pitch = audioPitch;
    ...
    public sealed class AudioController : Singleton<AudioController>
    {
        ...
        private const string MUSIC_SOUND = "Ambiance";
