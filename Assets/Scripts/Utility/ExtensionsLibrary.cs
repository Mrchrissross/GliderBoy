...
namespace GliderBoy.Utility
{
    ...
    public static class ExtensionsLibrary
    {
        ...
        /// <summary>
        /// Returns a copy of given color as a color with its A component as the given value.
        /// </summary>
        ...
        /// <summary>
        /// Moves an element within a list.
        /// </summary>
        /// <param name="oldIndex">Index of element to be moved.</param>
